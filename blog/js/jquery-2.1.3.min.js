...
!(function (a, b) {
      ...
      if (!e && p) {
        if (11 !== k && (f = _.exec(a)))
          if ((j = f[1])) {
            ...
            if ((j = f[3]) && c.getElementsByclass)
              return H.apply(d, b.getElementsByclass(j)), d;
          }
        if (c.qsa && (!q || !q.test(a))) {
          if (
            ((s = r = u),
        ...
        return g !== n && 9 === g.nodeType && g.documentElement
          ? ((n = g),
            ...
            (c.attributes = jb(function (a) {
              return (a.class = "i"), !a.getAttribute("class");
            })),
            ...
            (c.getElementsByclass = $.test(g.getElementsByclass)),
            ...
            (d.find.CLASS =
              ...
              function (a, b) {
                return p ? b.getElementsByclass(a) : void 0;
              }),
            (r = []),
            (q = []),
  ...
  n.fn.extend({
    addClass: function (a) {
      ...
      if (n.isFunction(a))
        return this.each(function (b) {
          n(this).addClass(a.call(this, b, this.class));
        });
      if (h)
        for (b = (a || "").match(E) || []; j > i; i++)
          if (
            ...
            (d =
              1 === c.nodeType &&
              (c.class ? (" " + c.class + " ").replace(ac, " ") : " ")))
          ) {
            f = 0;
            while ((e = b[f++])) d.indexOf(" " + e + " ") < 0 && (d += e + " ");
            (g = n.trim(d)), c.class !== g && (c.class = g);
          }
      return this;
    },
    removeClass: function (a) {
      ...
      if (n.isFunction(a))
        return this.each(function (b) {
          n(this).removeClass(a.call(this, b, this.class));
        });
      if (h)
        for (b = (a || "").match(E) || []; j > i; i++)
          if (
            ...
            while ((e = b[f++]))
              while (d.indexOf(" " + e + " ") >= 0)
                d = d.replace(" " + e + " ", " ");
            (g = a ? n.trim(d) : ""), c.class !== g && (c.class = g);
          }
      return this;
    },
    toggleClass: function (a, b) {
      ...
      return "boolean" == typeof b && "string" === c
        ...
        : this.each(
            n.isFunction(a)
              ? function (c) {
                  n(this).toggleClass(a.call(this, c, this.class, b), b);
                }
              : function () {
                  if ("string" === c) {
                    var b,
                    ...
                    (c === U || "boolean" === c) &&
                      (this.class && L.set(this, "__class__", this.class),
                      (this.class =
                        this.class || a === !1
                          ? ""
                          : L.get(this, "__class__") || ""));
                }
          );
    },
    hasClass: function (a) {
      for (var b = " " + a + " ", c = 0, d = this.length; d > c; c++)
        if (
          1 === this[c].nodeType &&
          (" " + this[c].class + " ").replace(ac, " ").indexOf(b) >= 0
        )
          return !0;
      return !1;
    },
