    ...
    (mejs.MepDefaults = {
      ...
      (mejs.MediaElementPlayer.prototype = {
        ...
        changeSkin: function (a) {
          (this.container[0].class = "mejs-container " + a),
        ...
        i.docReady(function () {
          ...
          u.forEach(function (t) {
            ...
            try {
              ...
              return void (
                n && n.error("Error parsing " + s + " on " + t.class + ": " + a)
              );
            }
            var h = new e(t, i);
            c && c.data(t, o, h);
          ...
          for (
            ...
            if ((j !== h || e.test(k)) && !v.test(k)) {
              ...
              for (o = d.parentNode; o; o = o.parentNode)
                if (f.test(o.tagName) && o.class && e.test(o.class)) {
                  m = !0;
                  break;
                }
              if (!m) {
                d.class += " prettyprinted";
                m = j.lang;
                if (!m) {
                  var m = k.match(n),
                    y;
